...
if (mysqli_connect_errno()) {
    ...
    $query = false;
    // Mencari tabel tb_sktm_stunting di database
    $tableCandidates = ['tb_sktm_stunting', 'sktm_stunting'];
...
<div class="container-fluid px-4 py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <div>
            <h3 class="page-title-modern mt-2 mb-1">SKTM Terindikasi Stunting</h3>
            <ol class="breadcrumb breadcrumb-modern mb-0">
                <li class="breadcrumb-item"><a href="index.php?page=dashboard"
                        class="text-decoration-none">Dashboard</a></li>
                <li class="breadcrumb-item active">Daftar SKTM Stunting</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card card-modern mb-4">
        ...
        <div class="card-header-modern d-flex justify-content-between align-items-center">
            <div class="card-header-title d-flex align-items-center">
                <i class="fas fa-table me-2 text-primary"></i> Data Surat Keterangan Tidak Mampu (Stunting)
            </div>
            <!-- Tombol Tambah Halaman Baru Modern -->
            <a href="index.php?page=sktm-stunting-tambah" class="btn btn-primary btn-tambah-modern">
                ...
                <table class="table table-hover table-striped align-middle" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-uppercase text-success">
                                <?= htmlspecialchars($data['nama_anak']); ?></td>
                            <td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    ...
                                    <!-- Tombol Cetak -->
                                    <a href="pages/sktm_stunting/cetak.php?id=<?= $data['id_sktm']; ?>" target="_blank"
                                    ...
                                    <!-- Tombol Update -->
                                    <a href="index.php?page=sktm-stunting-edit&id=<?= $data['id_sktm']; ?>"
                                    ...
                                    <!-- Tombol Delete -->
                                    <a href="pages/sktm_stunting/proses_hapus.php?id=<?= $data['id_sktm']; ?>"
                                        class="btn btn-sm d-flex flex-column align-items-center justify-content-center action-btn btn-delete-modern"
                                        onclick="return confirm('Apakah Anda yakin ingin menghapus data SKTM Stunting ini?');"
                                        title="Hapus">
                        ...
                        <?php
                            ...
                            ?>
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4">Belum ada data surat SKTM Stunting.</td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
