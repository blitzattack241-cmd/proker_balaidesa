...
<div class="container-fluid px-4 py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <div>
            <h3 class="page-title-modern mt-2 mb-1">Surat Pengantar Dukcapil</h3>
    ...
    <div class="card card-modern mb-4">
        ...
        <div class="card-header-modern d-flex justify-content-between align-items-center">
            <div class="card-header-title d-flex align-items-center">
                <i class="fas fa-table me-2 text-primary"></i> Data Surat Pengantar Dukcapil
            </div>
            <!-- Tombol Tambah Halaman Baru Modern -->
            <a href="index.php?page=surat-pengantar-dukcapil-tambah" class="btn btn-primary btn-tambah-modern">
                ...
                <table class="table table-hover table-striped align-middle" id="dataTable" width="100%" cellspacing="0">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th width="35%">Jenis Yang Dikirim</th>
                        ...
                        if ($query && mysqli_num_rows($query) > 0) {
                            while ($data = mysqli_fetch_assoc($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $tanggal; ?></td>
                                    <td>
                                        <?= nl2br(htmlspecialchars(substr($data['jenis_dikirim'], 0, 100))); ?>        <?= strlen($data['jenis_dikirim']) > 100 ? '...' : ''; ?>
                                    </td>
                                    <td><span
                                            class="badge bg-light text-dark p-2 border"><?= htmlspecialchars($data['banyaknya']); ?></span>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center gap-2">

                                            <!-- Tombol Cetak -->
                                            <a href="pages/surat_pengantar_dukcapil/cetak.php?id=<?= $data['id_surat']; ?>"
                                                target="_blank"
                                            ...
                                            <!-- Tombol Update -->
                                            <a href="index.php?page=surat-pengantar-dukcapil-edit&id=<?= $data['id_surat']; ?>"
                                            ...
                                            <!-- Tombol Delete -->
                                            <a href="pages/surat_pengantar_dukcapil/proses_hapus.php?id=<?= $data['id_surat']; ?>"
                                                class="btn btn-sm d-flex flex-column align-items-center justify-content-center action-btn btn-delete-modern"
                                                onclick="return confirm('Apakah Anda yakin ingin menghapus data surat ini?');"
                                                title="Hapus">
                            ...
                            ?>
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4">Belum ada data surat pengantar.</td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
