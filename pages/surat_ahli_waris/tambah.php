...
<div class="container-fluid px-4 py-3">
    <div class="mb-4">
        <h3 class="page-title-modern mt-2 mb-1">Buat Surat Keterangan Ahli Waris Baru</h3>
        <ol class="breadcrumb breadcrumb-modern mb-0">
            <li class="breadcrumb-item"><a href="index.php?page=dashboard" class="text-decoration-none">Dashboard</a>
            </li>
            <li class="breadcrumb-item"><a href="index.php?page=surat-keterangan-ahli-waris"
                    class="text-decoration-none">Daftar Surat Waris</a></li>
    ...
    <div class="card card-modern mb-4">
        <div class="card-header-modern d-flex align-items-center">
            <i class="fas fa-file-medical me-2 text-primary"></i> Formulir Input Data Ahli Waris
        </div>
        <div class="card-body p-4">
            <form action="pages/surat_ahli_waris/proses_tambah.php" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="tempat_meninggal" class="form-control"
                            placeholder="Contoh: desa Berugenjang Rt 001 Rw 001 Undaan Kudus" required>
                    </div>
                    <div class="col-12">
                        ...
                        <textarea name="alamat_terakhir" class="form-control" rows="2"
                            placeholder="Alamat lengkap domisili terakhir mendiang" required></textarea>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="status_pasangan" class="form-select">
                            ...
                            <option value="Alm">Sudah Meninggal Dunia (Alm)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama_camat" class="form-control" value="Camat Undaan">
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-3">
                    <a href="index.php?page=surat-keterangan-ahli-waris"
                        class="btn btn-light btn-custom text-secondary border">
                    ...
                    <button type="submit" class="btn btn-primary btn-custom shadow">
                        <i class="fas fa-save me-1"></i> Simpan Arsip Surat
                    </button>
                </div>
