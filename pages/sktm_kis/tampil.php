...
<div class="container-fluid px-4 py-3">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <div>
            <h3 class="page-title-modern mt-2 mb-1">Surat Keterangan Tidak Mampu (KIS)</h3>
            <ol class="breadcrumb breadcrumb-modern mb-0">
                <li class="breadcrumb-item"><a href="index.php?page=dashboard"
                        class="text-decoration-none">Dashboard</a></li>
                <li class="breadcrumb-item active">Daftar SKTM KIS</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card card-modern mb-4">
        <div class="card-header-modern d-flex justify-content-between align-items-center">
            <div class="card-header-title d-flex align-items-center">
                <i class="fas fa-file-alt me-2 text-primary"></i> Data Pengajuan SKTM KIS Desa
            </div>
            <a href="index.php?page=sktm-kis-tambah" class="btn btn-primary btn-tambah-modern text-white">
                ...
                <table class="table table-hover table-striped align-middle" id="dataTable" width="100%" cellspacing="0">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th width="12%" class="text-center">Tgl Surat</th>
                            <th width="10%" class="text-center">Dokumentasi</th>
