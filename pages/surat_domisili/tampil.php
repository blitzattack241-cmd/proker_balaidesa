...
<div class="container-fluid px-3 py-3">
    ...
    <div class="card card-modern mb-4">
        <div class="card-header-modern d-flex justify-content-between align-items-center">
            ...
            <!-- Route disesuaikan dengan switch-case main dashboard -->
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center gap-1">
                                            <!-- Aksi Cetak langsung target blank ke file generator cetak -->
                                            <a href="pages/surat_domisili/cetak.php?id=<?= $row['id_domisili']; ?>"
                                                target="_blank" class="btn btn-sm action-btn btn-cetak-modern"
                                                title="Cetak Surat">
                                                <i class="fas fa-print"></i> Cetak
                                            </a>
                                            <!-- Aksi Edit via Routing Dashboard -->
                                            <a href="index.php?page=surat-domisili-edit&id=<?= $row['id_domisili']; ?>"
                                                class="btn btn-sm action-btn btn-update-modern" title="Edit Data">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <!-- Aksi Hapus via Routing Dashboard atau file handler -->
