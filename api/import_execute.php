...
// ensure $koneksi from koneksi.php is available
global $koneksi;
...
$headerIndex = isset($payload['header_index']) ? (int)$payload['header_index'] : 0;
    ...
    echo json_encode(['inserted' => $inserted, 'updated' => $updated, 'skipped' => $skipped, 'failed' => $failed, 'fail_rows' => $failRows], JSON_UNESCAPED_UNICODE);
